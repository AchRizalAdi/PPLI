    ...
    <div class="profile-setting-panel-wrap">
      ...
      >
        <li
          class="nav-item"
          role="presentation"
          v-for="list in SectionData.paymentMethodData.paymentMethodTabNav"
          :key="list.id"
        >
          <button
            class="nav-link"
      ...
      <div class="tab-content mt-4" id="myTabContent">
        ...
        >
          <div class="profile-setting-panel">
            ...
            <p class="mb-3 fs-14">
              ...
              complete series of work from the beginning until the job is
              completed safely and on time. With the availability of sufficient
              resources both types of means of transport from cars Pick-up Truck
              Boxes, Tronton, Built-up truck and others. Armed with experience
              and professional way of working that would further the
              implementation of a work in accordance with the services offered
              will achieve results in accordance with the expectations of its
              customers. In accordance with the wishes of the Majapahit
              Logistics in particular to its customers, so we want to provide
              the best service according to the customer / customers. As a brief
              overview of the services we offer are : Ekspor – Impor Packaging –
              Moving dan Transportasi Domestik & International kurir & Kargo In
        ...
        <div
          ...
          id="credit-cards"
          role="tabpanel"
          aria-labelledby="credit-cards-tab"
        >
          <div class="profile-setting-panel">
            ...
            <div class="row g-gs">
              <div
                class="col-md-6"
                v-for="item in SectionData.creditCardList"
                :key="item.id"
              >
      ...
      <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <p class="small mb-2">
              Make sure your name and bank information match your bank account.
              Otherwise, your transactions won't go through and you'll be
              charged a fee.
            </p>
            <p class="small mb-3">
              By continue, you agree to the EnftyMart's Terms and Service and
              Privacy Policy
            </p>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="billing-form-wrap">
              ...
              <input
                type="text"
                class="form-control form-control-s1 my-3"
        ...
        <div class="modal-content">
          <div class="modal-body text-center">
            ...
            <h4 class="modal-tilte mb-2">
              {{ SectionData.deleteModal.titleTwo }}
            </h4>
