        ...
        <div class="col-lg-6 col-md-9">
          ...
          <form @submit.prevent="postRegisters()">
            ...
            <!-- <div class="form-group mb-2">
              ...
              <select class="form-control" v-model="companyindustry" required>
                <option
                  v-for="industri in industris.data"
                  :value="industri.id"
                  :key="industri.id"
                >
                  {{ industri.name }}
...
export default {
  ...
  methods: {
    ...
    getCities: function() {
      alert(document.getElementById('provinsis').value);
      axios
        .get(
          "http://127.0.0.1:8000/api/select/city/" +
            document.getElementById("provinsis")
        )
        .then(
          function (response) {
