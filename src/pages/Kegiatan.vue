...
<div class="page-wrap">
    ...
    <section class="user-panel-section section-space">
            <div class="container">
                <div class="row">
                    <!-- user sidebar -->
                    <UserSidebar :title="SectionData.kegiatanSidebarData.title" :lists="SectionData.kegiatanSidebarData.navList"></UserSidebar>
                    <!-- offer -->
                    <KegiatanSection class="mt-4 mt-lg-0"></KegiatanSection>
                </div><!-- end row -->
            </div><!-- end container -->
