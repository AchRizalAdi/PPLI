...
<div class="page-wrap">
    ...
    <section class="user-panel-section section-space">
            <div class="container">
                <div class="row">
                    <!-- user sidebar -->
                    <UserSidebar :title="SectionData.memberSidebarData.title" :lists="SectionData.memberSidebarData.navList"></UserSidebar>
                    <!-- offer -->
                    <MembersSection class="mt-4 mt-lg-0"></MembersSection>
                </div><!-- end row -->
            </div><!-- end container -->
