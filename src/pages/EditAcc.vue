...
<div class="page-wrap">
    ...
    <section class="user-panel-section section-space">
            <div class="container">
                <div class="row">
                    <!-- user sidebar -->
                    <UserSidebar :title="SectionData.editAccSidebarData.title" :lists="SectionData.editAccSidebarData.navList" :navs="SectionData.editAccTabNavMobile"></UserSidebar>
                    <!-- offer -->
                    <EditAccSection></EditAccSection>
                </div><!-- end row -->
            </div><!-- end container -->
